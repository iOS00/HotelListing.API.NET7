...
namespace HotelListing.API.Controllers
{
    ...
    public class CountriesController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCountry(int id, Country country)  // replace current with country
        {
            if (id != country.Id)
            {
        ...
        public async Task<IActionResult> DeleteCountry(int id)
        {
            ...
            _context.Countries.Remove(country);  //turns EntityState.Deleted
            await _context.SaveChangesAsync();
